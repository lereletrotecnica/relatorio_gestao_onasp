...
[^acoes-1]: Importante ressaltar que, no anos de 2020 e 2021, houve adaptação do cronograma de inspeções devido a pandemia de coronavírus declarada pela Organização Mundial de Saúde em março de 2020.
...
Os indicadores de atendimento dos processos relativos ao SIC Setorial da Senappen estão relacionados na tabela abaixo. As informações são extraídas do Sistema Eletrônico de Informações (SEI). Com relação ao ano de 2021, os dados foram coletados a partir de outubro, pois 
a ouvidoria encarregou-se dos procedimentos de tratamento desse tipo de demanda a partir do referido mês, conforme  Decreto nº 10.785, de 1º de setembro de 2021. 
...
Entre 2020 e 2022, houve um aumento de 35% na quantidade de colaboradores lotados na Ouvidoria Nacional dos Serviços Penais. Além disso, houve pouca rotatividade entre os membros da equipe.

A tabela abaixo mostra essa variação, detalhadamente.
...
-   Gerenciamento e tratamento dos dados coletados pela ouvidoria, além de elaboração de relatórios;
